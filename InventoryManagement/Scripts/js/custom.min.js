function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) { 
        var c = $(this).parent();
        var chileEle=c.find("ul.child_menu");
        console.log("chileEle:",chileEle);
        c.is(".active") ? (c.removeClass("active active-sm"), $("ul:first", c).slideUp(function () { a() })) : (c.parent().is(".child_menu") ?/*my changes*/ ($BODY.is(".nav-sm") && chileEle.length==0) && ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()) /*alert("in condition")*/ : ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()), c.addClass("active"), $("ul:first", c).slideDown(function () { a() }))
    }), 
